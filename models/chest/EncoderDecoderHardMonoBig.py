'''
This is the former script for the Hard constrained version of the Encoder-Decoder model. Only one change btw it and the current (04/09/2025) version :
In current version, in the Decoder class, Rest connections are only used in monotonic channels.
'''
import torch
